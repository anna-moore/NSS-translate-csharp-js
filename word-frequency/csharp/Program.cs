...
namespace WordFrequency
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            List<KeyValuePair<string, int>> freqList = freqCounts.ToList();
            freqList.Sort((kvp1, kvp2) => kvp1.Key.CompareTo(kvp2.Key));

            foreach (KeyValuePair<string, int> kvp in freqList)
            {
